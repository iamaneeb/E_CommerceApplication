"""
Django settings for E_CommerceApplication project.
...
ROOT_URLCONF = 'E_CommerceApplication.urls'
...
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD')  # Use the app password here
